...
tick = 0
surface_cnot(circuit_builder, distance, offset1, rotation, tick)
surface_cnot_rot90(circuit_builder, distance, offset2, rotation, tick)
surface_cnot_mirror_ud(circuit_builder, distance, offset3, rotation, tick)
...
circuit_builder.mz((0.5 + offset[0], 5.5 + offset[1]))
circuit_builder.classical_cnot((1 + offset[0], 5 + offset[1]))
circuit_builder.mz((6 + offset[0], 5 + offset[1]))
circuit_builder.classical_cnot((5.5 + offset[0], 4.5 + offset[1]))
circuit_builder.mz((1 + offset[0], 1 + offset[1]))
...
surface_cnot_rot90(circuit_builder, distance, offset2, rotation, tick)
surface_cnot_mirror_ud(circuit_builder, distance, offset3, rotation, tick)
circuit_builder.ideal([(3 + offset[0], 5 + offset[1]), (5.5 + offset[0], 2.5 + offset[1]), (3.5 + offset[0], 1.5 + offset[1])])
circuit_builder.tick()
...
tag = 0
tag = surface_measurement_first(circuit_builder, distance, offset1, tag)
tag = 10
tag = surface_measurement_first_rot90(circuit_builder, distance, offset2, tag)
tag = 20
tag = surface_measurement_first_mirror_ud(circuit_builder, distance, offset3, tag)
# circuit_builder.ideal_start()
...
# circuit_builder.ideal_start()
tick = 0
surface_cnot_2(circuit_builder, distance, offset1, rotation2, tick)
surface_cnot_2_rot90(circuit_builder, distance, offset2, rotation2, tick)
surface_cnot_2_mirror_ud(circuit_builder, distance, offset3, rotation2, tick)
# circuit_builder.ideal_end()
circuit_builder.tick()
...
# circuit_builder.ideal_start()
tag = 0
tag = surface_measurement(circuit_builder, distance, offset1, tag, True)
tag = 10
tag = surface_measurement_rot90(circuit_builder, distance, offset2, tag, True)
tag = 20
tag = surface_measurement_mirror_ud(circuit_builder, distance, offset3, tag, True)
# circuit_builder.ideal_end()
circuit_builder.tick()
...
surface_ancilla_initialization_x_rot90(circuit_builder, distance, offset2)
surface_ancilla_initialization_x_mirror_ud(circuit_builder, distance, offset3)
surface_ancilla_initialization_x_boundary(circuit_builder, distance, offset1)
surface_ancilla_initialization_x_boundary_rot90(circuit_builder, distance, offset2)
surface_ancilla_initialization_x_boundary_mirror_ud(circuit_builder, distance, offset3)
circuit_builder.tick()

# for j in range(4):
for i in range(4):
    surface_cnot_2(circuit_builder, distance, offset1, rotation2, i)
    surface_cnot_boundary_2(circuit_builder, distance, offset1, rotation2, i)
    surface_cnot_2_rot90(circuit_builder, distance, offset2, rotation2, i)
    surface_cnot_boundary_2_rot90(circuit_builder, distance, offset2, rotation2, i)
    surface_cnot_2_mirror_ud(circuit_builder, distance, offset3, rotation2, i)
    surface_cnot_boundary_2_mirror_ud(circuit_builder, distance, offset3, rotation2, i)
    circuit_builder.tick()

tag = 0
tag = surface_measurement(circuit_builder, distance, offset1, tag, True)
tag = surface_measurement_boundary(circuit_builder, distance, offset1, tag, True)
tag = 10
tag = surface_measurement_rot90(circuit_builder, distance, offset2, tag, True)
tag = surface_measurement_boundary_rot90(circuit_builder, distance, offset2, tag, True)
tag = 20
tag = surface_measurement_mirror_ud(circuit_builder, distance, offset3, tag, True)
tag = surface_measurement_boundary_mirror_ud(circuit_builder, distance, offset3, tag, True)
...
tag = 0
tag = surface_measurement(circuit_builder, distance, offset1, tag, False)
tag = surface_measurement_boundary(circuit_builder, distance, offset1, tag, False)
tag = 10
tag = surface_measurement_rot90(circuit_builder, distance, offset2, tag, False)
tag = surface_measurement_boundary_rot90(circuit_builder, distance, offset2, tag, False)
tag = 20
tag = surface_measurement_mirror_ud(circuit_builder, distance, offset3, tag, False)
tag = surface_measurement_boundary_mirror_ud(circuit_builder, distance, offset3, tag, False)
...
"""
1e-3, 5e6, 0.0002703683888719046, 0.418688
8e-4, 5e6, 0.00019523066744384006, 0.4978726
6e-4, 5e6, 0.00010763579824934929, 0.5927396
4e-4, 5e6, 4.65009456137416e-05, 0.705362
2e-4, 5e6, 1.1667975146736694e-05, 0.8399058
1e-4, 5e6, 3.1638657726672983e-06, 0.9166002
"""